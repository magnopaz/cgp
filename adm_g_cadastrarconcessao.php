	...
	<head>
		...
		<script type="text/javascript">
			...
			function gravafailed(){
				setTimeout("window.location='adm_cadastrarconcessao.php'", 5000);
        ...
        <?php 
            ...
            if(!isset($_SESSION["usuario"]) || !isset($_SESSION["senha"])){
                ...
                if (isset($_POST['proxima_vistoria'])){
                    $concessaogravar['proxima_vistoria']= traduz_data_para_banco($_POST['proxima_vistoria']);
                } else {
                    $concessaogravar['proxima_vistoria'] = '';
                }
