...
function grava_concessao($conexao, $concessaogravar){
    $sqlGravar = "INSERT INTO concessoes (cessionario, finalidade, processoNumero, processoData, objetoConcessao, instrumentoLegal, dataInicio, dataFinalidade, dataTermino) VALUES ('{$concessaogravar['cessionario']}', '{$concessaogravar['finalidade']}', '{$concessaogravar['processoNumero']}', '{$concessaogravar['processoData']}', '{$concessaogravar['objetoConcessao']}', '{$concessaogravar['instrumentoLegal']}', '{$concessaogravar['dataInicio']}', '{$concessaogravar['dataFinalidade']}', '{$concessaogravar['dataTermino']}')";
