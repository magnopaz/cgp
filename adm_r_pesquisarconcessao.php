	...
	<body>
        <?php
			...
			while ($rs = $query->fetch_array()){
                ...
                Próxima Vistoria:<br />' . traduz_data_para_exibir($rs[proxima_vistoria]) . '<br/>
                ...
                echo '</fieldset>';
                ?>
                <form name="formalterar" method="post" action="adm_alterarConcessao.php">
        ...
        <form action="adm_pesquisarconcessao.php">
