...
<html>
    ...
    <body id="home">
        ...
        <form name="formdisponivel" method="post" action="g_admcadastrardisponivel.php">
            ...
            Registro nº: <textarea name="matriculaimovel" rows="1" cols="15"></textarea>
            ...
            Situação do imóvel: <SELECT name="situacaoimovel">
                ...
                <OPTION VALUE="11">Reservado</OPTION>
            </SELECT><br /><br />
            Observações ou Averbações:<br /><br /> <textarea name="observacoesimovel" rows="3" cols="100"></textarea><br /><br />
            Última vistoria (deve ser no formato 11/11/1111):	<input type="text" name="ultima_vistoria" /><br /><br />
