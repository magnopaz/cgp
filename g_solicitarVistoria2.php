    ...
    <head>
        ...
        <script type="text/javascript">
            function gravasuccessfully() {
                setTimeout("window.location='disponivel.php'", 5000);
                echo
            }
            function gravafailed() {
                setTimeout("window.location='enviarMensagem.php'", 5000);
