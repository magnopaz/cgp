	...
	<head>
		...
		<script type="text/javascript">
			function gravasuccessfully(){
				setTimeout("window.location='admconcessao.php'", 5000);
				echo 
			}
	...
	<body>
        ...
        <?php 
            ...
            if(!isset($_SESSION["usuario"]) || !isset($_SESSION["senha"])){
                ...
                if (isset($_POST['proxima_vistoria'])){
                    $proxima_vistoria= traduz_data_para_banco($_POST['proxima_vistoria']);
                } else {
                    $proxima_vistoria = '';
                }
