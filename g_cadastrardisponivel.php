<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function gravafailed() {
                setTimeout("window.location='cadastrardisponivel.php'", 5000);
    ...
    <body>
        ...
        if (isset($_POST['ultima_vistoria'])){
                    $concessaogravar['ultima_vistoria']= traduz_data_para_banco($_POST['ultima_vistoria']);
                } else {
                    $concessaogravar['ultima_vistoria'] = '';
                }
